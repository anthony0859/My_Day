...
//        removeAllItemButton = (Button)findViewById(R.id.button3);
    ...
    public void testRemoveItemClick(){
	    ...
	    OverlayTest ov = new OverlayTest(mMapView,marker, this);
...
class OverlayTest extends ItemizedOverlay<OverlayItem> {
	...
	public OverlayTest(MapView mv,Drawable marker,Context context){
		super(marker);
		this.mContext = context;
        pop = new PopupOverlay( mv,new PopupClickListener() {
